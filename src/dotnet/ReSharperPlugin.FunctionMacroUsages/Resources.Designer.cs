...
namespace ReSharperPlugin.FunctionMacroUsages
{
  ...
  {
    private static readonly ILogger ourLog = Logger.GetLogger("ReSharperPlugin.FunctionMacroUsages.Resources");
      ...
      CultureContextComponent.Instance.Change.Advise(Lifetime.Eternal, args =>
      {
          ...
          if (instance != null)
          {
            ourResourceManager = new Lazy<JetResourceManager>(
              ...
              {
                return instance
                  .CreateResourceManager("ReSharperPlugin.FunctionMacroUsages.Resources", typeof(Resources).Assembly);
              });
          }
          else
          {
